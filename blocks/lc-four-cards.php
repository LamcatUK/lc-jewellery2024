		...
		<div class="lc-four-cards__grid">
			...
			<div class="lc-four-cards__card-img lc-four-cards__card-img--featured">
				...
				wp_get_attachment_image(
					...
					false,
					array(
						'class' => 'lc-four-cards__img lc-four-cards__img--first',
						'style' => ! empty( $card1['image_offset'] ) ? 'object-position: ' . esc_attr( $card1['image_offset'] ) . ';' : '',
					)
				);
				?>
			</div>
			...
			<div class="lc-four-cards__cell lc-four-cards__cell--card">
				...
				<div class="lc-four-cards__card-img">
					...
					wp_get_attachment_image(
						...
						false,
						array(
							'class' => 'lc-four-cards__img',
							'style' => ! empty( $card2['image_offset'] ) ? 'object-position: ' . esc_attr( $card2['image_offset'] ) . ';' : '',
						)
					);
					?>
				</div>
			...
			<div class="lc-four-cards__cell lc-four-cards__cell--card">
				...
				<div class="lc-four-cards__card-img">
					...
					wp_get_attachment_image(
						...
						array(
							'class' => 'lc-four-cards__img',
							'style' => ! empty( $card3['image_offset'] ) ? 'object-position: ' . esc_attr( $card3['image_offset'] ) . ';' : '',
						)
					);
					?>
				</div>
			...
			<div class="lc-four-cards__cell lc-four-cards__cell--card">
				...
				<div class="lc-four-cards__card-img">
					...
					wp_get_attachment_image(
						...
						array(
							'class' => 'lc-four-cards__img',
							'style' => ! empty( $card4['image_offset'] ) ? 'object-position: ' . esc_attr( $card4['image_offset'] ) . ';' : '',
						)
					);
					?>
				</div>
