...
$block_id  = $block['id'] ?? wp_unique_id( 'lc-image-cta-' );
...
$content_align = ( 'centre' === $alignment ) ? 'text-center align-items-center' : 'text-start align-items-start';
?>
<section id="<?= esc_attr( $block_id ); ?>" class="image-cta">
	<?php
	if ( $bg ) {
		echo wp_get_attachment_image( $bg['ID'], 'full', false, array( 'class' => 'image-cta__bg image-cta__bg--parallax' ) );
	}
	?>

	<div class="image-cta__overlay"></div>

	<div class="container-xl image-cta__content">
		<div class="d-flex flex-column <?= esc_attr( $content_align ); ?>">
...
document.addEventListener('DOMContentLoaded', function () {
	...
	var img = section.querySelector('.image-cta__bg--parallax');
	if (!img) return;
