...
<body <?php body_class(); ?>
    ...
    <header class="navholder" id="navholder">
            ...
            <div class="container-xl">
                <div class="pre_nav__container">
                    ...
                    <a href="/" class="logo-container" aria-label="Home">
                        <img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/logo.svg' ); ?>" alt="" width="310" height="50">
                    </a>
                    <a class="d-none d-lg-grid pre_nav__link" href="mailto:<?= antispambot( 'enquiries@griffinandsloane.com' ); ?>">Email us</a>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            <div class="offcanvas-header">
                <a href="/" class="logo-container" aria-label="Home">
                    <img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/logo-full.svg' ); ?>" alt="" width="1020" height="334">
                </a>
    ...
    if ( function_exists( 'WC' ) ) {
        ...
        $checkout_url = wc_get_checkout_url(); // Get the URL of the checkout page.
